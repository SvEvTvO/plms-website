            ...
            <form action="{{ route('bookmarks.store') }}" method="POST" x-data="bookmarkForm()" x-init="initSetup()">
                ...
                <div class="mb-8">
                    ...
                    <div class="relative">
                        ...
                        <input type="url" name="url" id="url" required value="{{ old('url', request('url')) }}" placeholder="https://..." class="w-full pl-11 bg-slate-50 rounded-2xl border-slate-200 focus:bg-white focus:border-primary focus:ring-primary shadow-sm text-sm h-12 transition-colors">
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                    ...
                    <div>
                        ...
                        <!-- STATE 2: BUAT KATEGORI BARU (INLINE FORM DENGAN ICON PICKER) -->
                        <div x-show="isCreatingCategory" style="display: none;" x-transition class="p-4 bg-primary-50/50 border border-primary-100 rounded-2xl">
                            ...
                            <!-- Input Nama & Picker Ikon Kategori -->
                            <div class="relative flex items-center gap-2 mb-3">
                                <!-- Tombol Picker Ikon Kategori -->
                            ...
                            <!-- INNER STATE: BUAT GRUP BARU DENGAN ICON PICKER -->
    ...
    <script>
        function bookmarkForm() {
            return {
                ...
                // Daftar Ikon Tabler Populer untuk Dipilih
                popularIcons: [
                    'folder', 'code', 'palette', 'device-laptop', 'brain', 
                    'rocket', 'sparkles', 'flame', 'star', 'book', 
                    'shopping-cart', 'bulb', 'tool', 'heart', 'camera', 
                    'music', 'world', 'chart-bar', 'news', 'shield', 
                    'compass', 'cpu', 'database', 'cloud', 'briefcase'
                ],
                ...
                // State Kategori Baru (Inline Create)
                isCreatingCategory: false,
                newCategoryName: '{{ old("new_category_name", "") }}',
                categoryIcon: 'folder', // Default icon folder
                isCategoryIconPickerOpen: false,
                
                // State Grup Baru (Inline Create)
                ...
                groupIcon: 'folder', // Default icon folder
                ...
                startCreateCategory() {
                    this.isCreatingCategory = true;
                    this.newCategoryName = this.categorySearch;
                    this.categoryId = ''; 
                    this.categoryIcon = 'folder';
                ...
                selectGroup(grp) {
                    this.groupId = grp.id; this.groupSearch = grp.name; this.selectedGroupName = grp.name; this.isGroupOpen = false;
                },
                startCreateGroup() {
                    this.isCreatingGroup = true;
                    this.newGroupName = this.groupSearch;
                    this.groupIcon = 'folder';
                    this.groupId = '';

<x-app-layout>
    <div class="max-w-3xl mx-auto space-y-6">
        ...
        <div class="mb-4">
            ...
            <h2 class="text-3xl font-heading font-bold text-gray-900 leading-tight">Buat Sub-Kategori</h2>
            <p class="text-sm text-gray-500 mt-1">Tambahkan folder bagian dalam untuk mengelompokkan website secara lebih spesifik.</p>
        </div>
                ...
                <div class="space-y-8">
                    ...
                    <div>
                        <div class="flex items-center justify-between mb-3">
                            <label class="block font-bold text-xs tracking-wider text-gray-500 uppercase">1. Pilih Folder Utama (Master) <span class="text-red-500">*</span></label>
                            <a href="{{ route('master-categories.create') }}" class="text-[11px] font-bold text-primary hover:underline">Buat Baru +</a>
                        </div>

                        <!-- Hapus pr-1 dan ganti p-1 agar tidak memicu scrollbar -->
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 max-h-[260px] overflow-y-auto custom-scrollbar p-1">
                            @foreach($masterCategories as $master)
                                ...
                                <!-- Class 'block' agar relative posisinya bekerja sempurna -->
                                <label class="cursor-pointer group relative block">
                                    ...
                                    <!-- Tambahkan padding kanan (pr-10) agar teks tidak menabrak centang -->
                                    <div class="relative flex items-center gap-3 p-3 pr-10 bg-white border border-gray-200 rounded-[16px] hover:border-gray-300 peer-checked:border-transparent peer-checked:ring-2 transition shadow-sm" style="--tw-ring-color: {{ $hexColor }};">
                                        ...
                                        <!-- Indikator Centang (DIPINDAHKAN KE DALAM, rata tengah vertikal di kanan) -->
                    ...
                    <div class="bg-gray-50/50 p-6 sm:p-8 rounded-[24px] border border-gray-100 space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="name" id="name" required placeholder="Contoh: UI Inspiration, Frameworks PHP..." class="w-full bg-white rounded-[14px] border-gray-200 focus:border-primary focus:ring-primary shadow-sm text-sm h-[46px]" value="{{ old('name') }}">
                        ...
                        <div>
                            ...
                            <textarea name="description" id="description" rows="3" placeholder="Jelaskan spesifikasi website yang masuk ke dalam folder ini..." class="w-full bg-white rounded-[14px] border-gray-200 focus:border-primary focus:ring-primary shadow-sm text-sm">{{ old('description') }}</textarea>
